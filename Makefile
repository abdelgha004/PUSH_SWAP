...
#    Updated: 2026/01/06 18:44:31 by aakourya         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC  = 	operations/push.c operations/swap.c operations/rotate.c operations/rev_rotate.c \
		...
		sort/sort_helpers.c sort/sort.c sort/sort_small.c sort/sort_medium.c sort/sort_large.c \
		stack/init_stack.c stack/stack_utils.c main.c
OBJ  = $(SRC:.c=.o)
all: $(NAME)
